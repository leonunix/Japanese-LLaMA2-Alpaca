"""
Usage: 
python merge_llama2_with_japanese_lora_low_mem.py \
    --base_model path/to/llama2-hf-model \
    --lora_model path/to/japanese-llama2-or-alpaca2-lora \
...
parser = argparse.ArgumentParser(description='Script to merge Llama-2-hf with japanese LLaMA-2 or Alpaca-2 LoRA weights')
parser.add_argument('--base_model', default=None, required=True,
                    type=str, help="Base model path (basically Llama-2-hf)")
parser.add_argument('--lora_model', default=None, required=True,
                    type=str, help="LoRA model path (japanese-LLaMA-2-LoRA, japanese-Alpaca-2-LoRA)")
