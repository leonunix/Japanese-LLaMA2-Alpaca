...
フルモデルのダウンロードリンクです。マージする必要がなく、そのまま使えます。
...
LoRAモデル（emb/lm-headを含む）単体のダウンロードリンクです。**LoRAモデルはそのままで使えず**、基盤モデルにマージしてフルモデルを作成してから使う必要があります。

| モデル                     |  モデルタイプ  |                      マージに必要の基盤モデル                      | ファイルサイズ |                    LoRAモデルダウンロードリング                    |
| :------------------------- | :------------: | :----------------------------------------------------------------: | :------------: | :----------------------------------------------------------------: |
